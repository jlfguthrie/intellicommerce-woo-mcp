...
const createTaxRateSchema = z.object({
  ...
  shipping: z
    .boolean()
    .optional()
    .describe("Whether or not this tax rate applies to shipping"),
});
...
const updateTaxRateSchema = createTaxRateSchema
  .extend({
    id: z.number().describe("Tax rate ID"),
  })
  .partial();
...
export const taxRateTools: Tool[] = [
  {
    name: "list_tax_rates",
    description:
      "Lists all tax rates with filtering, sorting, and pagination options",
    inputSchema: zodToJsonSchema(listTaxRatesSchema) as {
      type: "object";
  ...
  },
  {
    ...
    inputSchema: zodToJsonSchema(createTaxRateSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(getTaxRateSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(updateTaxRateSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(deleteTaxRateSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error listing tax rates: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error creating tax rate: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error getting tax rate: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error updating tax rate: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error deleting tax rate: ${errorMessage}` },
          ],
        },
      };
    }
