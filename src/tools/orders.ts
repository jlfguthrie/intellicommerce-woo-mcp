...
const listOrdersSchema = z.object({
  ...
  search: z
    .string()
    .optional()
    .describe("Search term for order ID or customer"),
  after: z
    .string()
    .optional()
    .describe("Limit response to orders placed after a given ISO8601 date"),
  before: z
    .string()
    .optional()
    .describe("Limit response to orders placed before a given ISO8601 date"),
  exclude: z
    .array(z.number())
    .optional()
    .describe("Exclude specific order IDs from the result"),
  include: z
    .array(z.number())
    .optional()
    .describe("Limit result set to specific order IDs"),
  offset: z
    .number()
    .optional()
  ...
  customer: z
    .number()
    .optional()
    .describe("Limit result set to orders assigned to specific customer IDs"),
  status: z
    .enum([
      "any",
      "pending",
    ...
    .optional()
    .describe("Limit result set to orders assigned a specific status"),
  orderby: z
  ...
  customer_is_paying: z
    .boolean()
    .optional()
    .describe("Filter orders by customers who are paying or have paid"),
...
export const orderTools: Tool[] = [
  {
    name: "list_orders",
    description:
      "Lists all orders with filtering, sorting, and pagination options",
    inputSchema: zodToJsonSchema(listOrdersSchema) as {
      type: "object";
  ...
  },
  {
    ...
    inputSchema: zodToJsonSchema(createOrderSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(getOrderSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(updateOrderSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(deleteOrderSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error listing orders: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error creating order: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error getting order: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error updating order: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error deleting order: ${errorMessage}` },
          ],
        },
      };
    }
