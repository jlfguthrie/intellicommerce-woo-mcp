...
const listCouponsSchema = z.object({
  ...
  search: z
    .string()
    .optional()
    .describe("Search term for coupon code or description"),
  after: z
    .string()
    .optional()
    .describe("Limit response to coupons published after a given ISO8601 date"),
  before: z
    .string()
    .optional()
    .describe(
      "Limit response to coupons published before a given ISO8601 date",
    ),
  exclude: z
    .array(z.number())
    .optional()
    .describe("Exclude specific coupon IDs from the result"),
  include: z
    .array(z.number())
    .optional()
    .describe("Limit result set to specific coupon IDs"),
  offset: z
    .number()
    .optional()
  ...
  orderby: z
    ...
    .optional()
    .describe("Sort coupons by parameter"),
});
...
const createCouponSchema = z.object({
  ...
  individual_use: z
    .boolean()
    .optional()
    .describe("If true, the coupon can only be used individually"),
  product_ids: z
    .array(z.number())
    .optional()
...
export const couponTools: Tool[] = [
  {
    name: "list_coupons",
    description:
      "Lists all coupons with filtering, sorting, and pagination options",
    inputSchema: zodToJsonSchema(listCouponsSchema) as {
      type: "object";
  ...
  },
  {
    ...
    inputSchema: zodToJsonSchema(createCouponSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(getCouponSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(updateCouponSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
  {
    ...
    inputSchema: zodToJsonSchema(deleteCouponSchema) as {
      type: "object";
      properties: Record<string, unknown>;
    },
  },
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error listing coupons: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error creating coupon: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error getting coupon: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error updating coupon: ${errorMessage}` },
          ],
        },
      };
    }
    ...
    try {
      ...
      return {
        toolResult: {
          isError: true,
          content: [
            { type: "text", text: `Error deleting coupon: ${errorMessage}` },
          ],
        },
      };
    }
